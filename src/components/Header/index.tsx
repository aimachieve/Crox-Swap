    ...
    <>
      ...
      {!isMd && !isSm && !isXs && !isLg ? (
        ...
        <StyledMenu className={snowBanner === 'croxmas' ? "menu_snow" : "menu"}>
              ...
              <StyledDropDownItem className="menu-item swap" onClick={() => history.push("/swap")}>
                <a style={{ marginTop: '3px', marginLeft: '7px' }}>
                  ...
                  <Flex flexDirection='column' ml='20px'>
                    <Text color="white" style={{ lineHeight: '24px' }} fontSize='14px' mt="10px">Exchange your tokens using Deltachain</Text>
                  </Flex>
                </a>
              </StyledDropDownItem>
              <StyledDropDownItem className="menu-item swap" onClick={() => history.push("/")}>
                <a style={{ marginTop: '3px', marginLeft: '7px' }}>
                  <Flex alignItems='center'>
                    <SwapHorizontalCircleIcon sx={{ fontSize: '20px' }} />
          ...
          <StyledButton className="button"><a href="#">XPad</a></StyledButton>
          <Separator />
